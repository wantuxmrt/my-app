...
import { Ticket, Priority, TicketStatus } from '@/types/app';
...
const AdminPanel: React.FC = () => {
  ...
  const { users, fetchUsers, updateUser, blockUser } = useUsersStore();
  const { tickets: allTickets, updateTicket } = useRequestsStore();
  ...
  const renderUserEditForm = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      e.preventDefault();
      updateUser(adminUserEdit.id, adminUserEdit);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            <Select
              ...
              onChange={(value) => setAdminUserEdit({...adminUserEdit, role: value})}
              options={[
