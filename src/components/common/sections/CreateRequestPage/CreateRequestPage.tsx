...
const CreateRequest = () => {
  ...
  const [categories, setCategories] = useState<Record<string, ProblemCategory> | null>(null);
  ...
  const handleCategorySelect = (category: string, subcategory = '', title = '', description = '') => {
    setRequestData(prev => ({
      ...prev,
      category,
      subcategory,
  ...
  const renderStep = () => {
    switch (step) {
        ...
        return (
          <div className={styles.prioritySelection}>
            ...
            <div className={styles.priorityGrid}>
              {categories && Object.entries(categories).map(([priority, data]) => (
                <div
                  key={priority}
      ...
      case 2:
        const currentCategory = requestData.priority && categories 
          ? categories[requestData.priority] 
          : null;
            ...
            <div className={styles.previewCard}>
              <div className={styles.previewHeader}>
                ...
                <span className={requestData.priority ? styles[requestData.priority] : ''}>
                  {requestData.priority && categories?.[requestData.priority]?.name}
                </span>
              </div>
